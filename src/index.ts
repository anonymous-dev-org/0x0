...
const commands = [
  lazy(
    {
      command: "$0",
      aliases: ["serve"],
      describe: "start 0x0 completion server",
    },
  ...
  lazy(
    {
      command: "commit-msg",
      describe: "generate commit message from staged changes",
    },
    command(() => import("./cli/cmd/commit-msg"), "CommitMsgCommand"),
  ),
  lazy(
    {
      command: "hook <action>",
    ...
    command(() => import("./cli/cmd/hook"), "HookCommand"),
  ),
]
