...
Saiba mais sobre [agents](https://docs.anonymous.dev/packages/0x0-cli/agents).

### Documentação

Para mais informações sobre como configurar o Terminal Agent, [**veja nossa documentação**](https://docs.anonymous.dev/packages/0x0-cli).
