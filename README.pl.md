...
Dowiedz się więcej o [agents](https://docs.anonymous.dev/packages/0x0-cli/agents).

### Dokumentacja

Więcej informacji o konfiguracji Terminal Agent znajdziesz w [**dokumentacji**](https://docs.anonymous.dev/packages/0x0-cli).
