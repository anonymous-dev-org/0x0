...
beforeAll(async () => {
  ...
  mock.module("@0x0-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@0x0-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@0x0-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@0x0-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
