export const dict = {
  ...
  "dialog.provider.zeroxzero.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje zeroxzero",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u zeroxzero-u.",
  ...
  "provider.connect.zeroxzero.line1":
    "zeroxzero Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.zeroxzero.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.zeroxzero.visit.prefix": "Posjeti ",
  "provider.connect.zeroxzero.visit.link": "zeroxzero.ai/zen",
  "provider.connect.zeroxzero.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u zeroxzero-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u zeroxzero-u.",
  ...
  "dialog.server.description": "Promijeni na koji se zeroxzero server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija zeroxzero-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku zeroxzero timu",
  ...
  "sidebar.gettingStarted.line1": "zeroxzero uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u zeroxzero-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako zeroxzero izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu zeroxzero-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se zeroxzero pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju zeroxzero-a.",
