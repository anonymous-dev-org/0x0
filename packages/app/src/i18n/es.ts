export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por zeroxzero",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en zeroxzero.",
  ...
  "provider.connect.zeroxzero.line1":
    "zeroxzero Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.zeroxzero.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.zeroxzero.visit.prefix": "Visita ",
  "provider.connect.zeroxzero.visit.link": "zeroxzero.ai/zen",
  "provider.connect.zeroxzero.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en zeroxzero.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en zeroxzero.",
  ...
  "dialog.plugins.empty": "Plugins configurados en zeroxzero.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de zeroxzero se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de zeroxzero ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de zeroxzero",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (zeroxzero.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, zeroxzero no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "zeroxzero incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "app.name.desktop": "zeroxzero Desktop",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para zeroxzero",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve zeroxzero en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de zeroxzero.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia zeroxzero",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de zeroxzero.",
  ...
  "settings.permissions.tool.task.description": "Lanzar agentes",
