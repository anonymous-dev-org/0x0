export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo zeroxzero",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no zeroxzero.",
  ...
  "provider.connect.zeroxzero.line1":
    "zeroxzero Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.zeroxzero.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.zeroxzero.visit.prefix": "Visite ",
  "provider.connect.zeroxzero.visit.link": "zeroxzero.ai/zen",
  "provider.connect.zeroxzero.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no zeroxzero.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no zeroxzero.",
  ...
  "dialog.plugins.empty": "Plugins configurados em zeroxzero.yaml",
  ...
  "dialog.server.description": "Trocar para qual servidor zeroxzero este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do zeroxzero ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do zeroxzero",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (zeroxzero.yaml)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: zeroxzero ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "zeroxzero inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do zeroxzero",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o zeroxzero aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o zeroxzero é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o zeroxzero iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do zeroxzero.",
