export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez zeroxzero",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w zeroxzero.",
  ...
  "provider.connect.zeroxzero.line1":
    "zeroxzero Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.zeroxzero.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.zeroxzero.visit.prefix": "Odwiedź ",
  "provider.connect.zeroxzero.visit.link": "zeroxzero.ai/zen",
  "provider.connect.zeroxzero.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w zeroxzero.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w zeroxzero.",
  ...
  "dialog.server.description": "Przełącz serwer zeroxzero, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja zeroxzero ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu zeroxzero",
  ...
  "sidebar.gettingStarted.line1": "zeroxzero zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla zeroxzero",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd zeroxzero na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw zeroxzero.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania zeroxzero",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji zeroxzero.",
