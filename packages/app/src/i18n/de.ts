...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von zeroxzero",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in zeroxzero zu nutzen.",
  ...
  "provider.connect.zeroxzero.line1":
    "zeroxzero Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.zeroxzero.visit.prefix": "Besuchen Sie ",
  "provider.connect.zeroxzero.visit.link": "zeroxzero.ai/zen",
  "provider.connect.zeroxzero.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in zeroxzero zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in zeroxzero zu nutzen.",
  ...
  "dialog.plugins.empty": "In zeroxzero.yaml konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den zeroxzero-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von zeroxzero ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem zeroxzero-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (zeroxzero.yaml) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: zeroxzero unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "zeroxzero enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für zeroxzero ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie zeroxzero auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von zeroxzero anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von zeroxzero automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von zeroxzero.",
