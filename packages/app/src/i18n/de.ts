...
export const dict = {
  ...
  "dialog.plugins.empty": "In zeroxzero.json konfigurierte Plugins",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (zeroxzero.json) auf Anbieter-/Modellnamen",
