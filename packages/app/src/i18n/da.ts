export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af zeroxzero",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i zeroxzero.",
  ...
  "provider.connect.zeroxzero.line1":
    "zeroxzero Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.zeroxzero.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.zeroxzero.visit.prefix": "Besøg ",
  "provider.connect.zeroxzero.visit.link": "zeroxzero.ai/zen",
  "provider.connect.zeroxzero.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i zeroxzero.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i zeroxzero.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i zeroxzero.yaml",
  ...
  "dialog.server.description": "Skift hvilken zeroxzero-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af zeroxzero ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til zeroxzero-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (zeroxzero.yaml) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, zeroxzero understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "zeroxzero inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for zeroxzero",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan zeroxzero ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan zeroxzero er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når zeroxzero starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af zeroxzero.",
