...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av zeroxzero",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i zeroxzero.",
  ...
  "provider.connect.zeroxzero.line1":
    "zeroxzero Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.zeroxzero.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.zeroxzero.visit.prefix": "Besøk ",
  "provider.connect.zeroxzero.visit.link": "zeroxzero.ai/zen",
  "provider.connect.zeroxzero.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i zeroxzero.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i zeroxzero.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i zeroxzero.yaml",
  ...
  "dialog.server.description": "Bytt hvilken zeroxzero-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av zeroxzero ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til zeroxzero-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (zeroxzero.yaml)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at zeroxzero ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "zeroxzero inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for zeroxzero",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan zeroxzero ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan zeroxzero er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når zeroxzero starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av zeroxzero.",
