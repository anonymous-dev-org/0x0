export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par zeroxzero",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans zeroxzero.",
  ...
  "provider.connect.zeroxzero.line1":
    "zeroxzero Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.zeroxzero.visit.prefix": "Visitez ",
  "provider.connect.zeroxzero.visit.link": "zeroxzero.ai/zen",
  "provider.connect.zeroxzero.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans zeroxzero.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans zeroxzero.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans zeroxzero.json",
  ...
  "dialog.server.description": "Changez le serveur zeroxzero auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'zeroxzero ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe zeroxzero",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (zeroxzero.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'zeroxzero ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "zeroxzero inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour zeroxzero",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'zeroxzero sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'zeroxzero.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'zeroxzero",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'zeroxzero.",
