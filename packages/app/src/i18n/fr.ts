export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans zeroxzero.yaml",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (zeroxzero.yaml) pour les noms de fournisseur/modèle",
