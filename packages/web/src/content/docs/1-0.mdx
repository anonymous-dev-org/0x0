...
description: What's new in Terminal Agent 1.0.
---

Terminal Agent 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same 0x0 server.
...
version. However some older versions of Terminal Agent always grab latest.
