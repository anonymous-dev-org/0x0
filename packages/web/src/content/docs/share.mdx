---
title: Share
description: Share your Terminal Agent conversations.
---

Terminal Agent's share feature allows you to create public links to your Terminal Agent conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Terminal Agent:
...
Terminal Agent supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Terminal Agent uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `0x0.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using 0x0 in your organization.
