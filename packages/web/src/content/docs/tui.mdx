---
title: TUI
description: Using the Terminal Agent terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Terminal Agent provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Terminal Agent starts the TUI for the current directory.
...
When using the Terminal Agent TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Terminal Agent. Allows you to select from available providers and add their API keys.
...
Exit Terminal Agent. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your Terminal Agent config file.
