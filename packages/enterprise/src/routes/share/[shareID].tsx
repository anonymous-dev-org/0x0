import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@0x0-ai/sdk/v2"
import { SessionTurn } from "@0x0-ai/ui/session-turn"
import { SessionReview } from "@0x0-ai/ui/session-review"
import { DataProvider } from "@0x0-ai/ui/context"
import { DiffComponentProvider } from "@0x0-ai/ui/context/diff"
import { CodeComponentProvider } from "@0x0-ai/ui/context/code"
import { WorkerPoolProvider } from "@0x0-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@0x0-ai/ui/logo"
import { IconButton } from "@0x0-ai/ui/icon-button"
import { ProviderIcon } from "@0x0-ai/ui/provider-icon"
import { createDefaultOptions } from "@0x0-ai/ui/pierre"
import { iife } from "@0x0-ai/util/iife"
...
import { Diff as SSRDiff } from "@0x0-ai/ui/diff-ssr"
import { clientOnly } from "@solidjs/start"
import { type IconName } from "@0x0-ai/ui/icons/provider"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyDiff = clientOnly(() => import("@0x0-ai/ui/diff").then((m) => ({ default: m.Diff })))
const ClientOnlyCode = clientOnly(() => import("@0x0-ai/ui/code").then((m) => ({ default: m.Code })))
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@0x0-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/zeroxzero-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | zeroxzero</Title>
              </Show>
              <Meta name="description" content="zeroxzero - The AI coding agent built for the terminal." />
                          ...
                          <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                            <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                              ...
                              <div class="flex gap-3 items-center">
                                <IconButton
                                  as={"a"}
                                  href="https://github.com/anomalyco/zeroxzero"
                                  target="_blank"
                                  icon="github"
                                  variant="ghost"
                                />
                                <IconButton
                                  as={"a"}
                                  href="https://zeroxzero.ai/discord"
                                  target="_blank"
                                  icon="discord"
                                  variant="ghost"
                                />
