...
import copyLogoSvgLight from "../asset/lander/zeroxzero-logo-light.svg"
import copyLogoSvgDark from "../asset/lander/zeroxzero-logo-dark.svg"
    ...
    <section data-component="top">
      <div onContextMenu={handleLogoContextMenu}>
        <A href={language.route("/")}>
          <img data-slot="logo light" src={logoLight} alt="Terminal Agent" width="189" height="34" />
          <img data-slot="logo dark" src={logoDark} alt="Terminal Agent" width="189" height="34" />
        </A>
      </div>
