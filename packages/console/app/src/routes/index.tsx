...
import video from "../asset/lander/zeroxzero-min.mp4"
import videoPoster from "../asset/lander/zeroxzero-poster.png"
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="paru">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">zeroxzero</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
