...
import { and, Database, eq, isNull, lt, or, sql } from "@0x0-ai/console-core/drizzle/index.js"
import { KeyTable } from "@0x0-ai/console-core/schema/key.sql.js"
import { BillingTable, SubscriptionTable, UsageTable } from "@0x0-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@0x0-ai/console-core/util/price.js"
import { getWeekBounds } from "@0x0-ai/console-core/util/date.js"
import { Identifier } from "@0x0-ai/console-core/identifier.js"
import { Billing } from "@0x0-ai/console-core/billing.js"
import { Actor } from "@0x0-ai/console-core/actor.js"
import { WorkspaceTable } from "@0x0-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@0x0-ai/console-core/model.js"
import { Black, BlackData } from "@0x0-ai/console-core/black.js"
import { UserTable } from "@0x0-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@0x0-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@0x0-ai/console-core/schema/provider.sql.js"
...
export async function handler(
  ...
  const FREE_WORKSPACES = [
    ...
    "wrk_01K6W1A3VE0KMNVSCQT43BG2SX", // zeroxzero bench
  ]
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-zeroxzero-session") ?? ""
    const requestId = input.request.headers.get("x-zeroxzero-request") ?? ""
    const projectId = input.request.headers.get("x-zeroxzero-project") ?? ""
    const ocClient = input.request.headers.get("x-zeroxzero-client") ?? ""
    logger.metric({
      is_tream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetch(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-zeroxzero-request")
          headers.delete("x-zeroxzero-session")
          headers.delete("x-zeroxzero-project")
          headers.delete("x-zeroxzero-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo) {
    ...
    if (!billing.paymentMethodID)
      throw new CreditsError(
        `No payment method. Add a payment method here: https://zeroxzero.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    if (billing.balance <= 0)
      throw new CreditsError(
        `Insufficient balance. Manage your billing here: https://zeroxzero.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    ...
    if (
      ...
      throw new MonthlyLimitError(
        `Your workspace has reached its monthly spending limit of $${billing.monthlyLimit}. Manage your limits here: https://zeroxzero.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    ...
    if (
      ...
      throw new UserLimitError(
        `You have reached your monthly spending limit of $${authInfo.user.monthlyLimit}. Manage your limits here: https://zeroxzero.ai/workspace/${authInfo.workspaceID}/members`,
      )
