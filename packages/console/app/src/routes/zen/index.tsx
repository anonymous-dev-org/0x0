...
import compareVideo from "../../asset/lander/zeroxzero-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/zeroxzero-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="zeroxzero:auth" content={loggedin() ? "true" : "false"} />
