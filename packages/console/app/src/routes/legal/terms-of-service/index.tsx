...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Terminal Agent | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Terminal Agent terms of service" />
          ...
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                ...
                our site located at zeroxzero.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using Terminal Agent?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Terminal Agent;
                </li>
                <li>
              ...
              <p>
                Terminal Agent has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-zeroxzero-ever-change-the-services">Will Terminal Agent ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://zeroxzero.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://zeroxzero.ai/auth">https://zeroxzero.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://zeroxzero.ai/legal/privacy-policy</a>, as well
              ...
              <p>
                ...
                ZEROXZERO PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO ZEROXZERO IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Terminal Agent Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Terminal Agent's prior written
              ...
              <p>
                YOU AND ZEROXZERO WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
              ...
              <p>
                ...
                relationship with Terminal Agent.
              </p>
