    ...
    <main data-page="home">
      ...
      <div data-component="content">
        <section data-component="top">
          <img data-slot="logo light" src={logoLight} alt="zeroxzero logo light" />
          <img data-slot="logo dark" src={logoDark} alt="zeroxzero logo dark" />
          ...
          <div data-slot="right">
            <button data-copy data-slot="command">
              <span>
                ...
                <span data-slot="highlight">zeroxzero.ai/install</span>
                <span> | bash</span>
              </span>
              <CopyStatus />
            </button>
        ...
        <section data-component="install">
          ...
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                paru -S <strong>zeroxzero-bin</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
        ...
        <footer data-component="footer">
          <div data-slot="cell">
            <a href="https://x.com/zeroxzero">{i18n.t("footer.x")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://github.com/anomalyco/zeroxzero">{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://zeroxzero.ai/discord">{i18n.t("footer.discord")}</a>
          </div>
        </footer>
      </div>
