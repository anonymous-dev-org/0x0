...
export const dict = {
  ...
  "notFound.title": "Nao encontrado | zeroxzero",
  ...
  "home.title": "Terminal Agent | O agente de codificacao com IA de codigo aberto",
  ...
  "home.what.title": "O que e Terminal Agent?",
  "home.what.body":
    "Terminal Agent e um agente de codigo aberto que ajuda voce a escrever codigo no terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Com mais de <strong>{{stars}}</strong> estrelas no GitHub, <strong>{{contributors}}</strong> colaboradores e mais de <strong>{{commits}}</strong> commits, Terminal Agent e usado e confiado por mais de <strong>{{monthlyUsers}}</strong> desenvolvedores todos os meses.",
  ...
  "home.privacy.body":
    "Terminal Agent nao armazena nenhum codigo seu nem dados de contexto, para poder operar em ambientes sensiveis a privacidade.",
  "home.privacy.learnMore": "Saiba mais sobre",
  "home.privacy.link": "privacidade",

  "home.faq.q1": "O que e Terminal Agent?",
  "home.faq.a1":
    "Terminal Agent e um agente de codigo aberto que ajuda voce a escrever e executar codigo com qualquer modelo de IA. Ele esta disponivel como interface de terminal, app desktop ou extensao de IDE.",
  "home.faq.q2": "Como eu uso o Terminal Agent?",
  "home.faq.a2.before": "A forma mais facil de comecar e ler a",
  "home.faq.a2.link": "introducao",
  "home.faq.q3": "Preciso de assinaturas extras de IA para usar o Terminal Agent?",
  "home.faq.a3.p1":
    "Nao necessariamente, Terminal Agent vem com um conjunto de modelos gratis que voce pode usar sem criar conta.",
  "home.faq.a3.p2.beforeZen": "Fora isso, voce pode usar modelos populares para codigo criando uma conta",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Embora incentivemos os usuarios a usar o Zen, Terminal Agent tambem funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Voce pode ate conectar seus",
  "home.faq.a3.p4.localLink": "modelos locais",
  "home.faq.q4": "Posso usar minhas assinaturas de IA existentes com o Terminal Agent?",
  "home.faq.a4.p1":
    "Sim, Terminal Agent oferece suporte a planos de assinatura dos principais provedores. Voce pode usar suas assinaturas Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Posso usar o Terminal Agent apenas no terminal?",
  "home.faq.a5.beforeDesktop": "Nao mais! Terminal Agent agora esta disponivel como um app para o",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto custa o Terminal Agent?",
  "home.faq.a6":
    "Terminal Agent e 100% gratis para usar. Tambem vem com um conjunto de modelos gratuitos. Pode haver custos adicionais se voce conectar outro provedor.",
  ...
  "home.faq.q8": "Terminal Agent e codigo aberto?",
  "home.faq.a8.p1": "Sim, Terminal Agent e totalmente open source. O codigo-fonte e publico no",
  ...
  "home.zenCta.body":
    "O Zen te da acesso a um conjunto selecionado de modelos de IA que a Terminal Agent testou e benchmarkou especificamente para agentes de codigo. Nao precisa se preocupar com desempenho e qualidade inconsistentes entre provedores: use modelos validados que funcionam.",
  "home.zenCta.link": "Saiba mais sobre o Zen",

  "download.title": "Terminal Agent | Download",

  "zen.title": "Terminal Agent Zen | Um conjunto selecionado de modelos confiaveis e otimizados para agentes de codigo",
  "zen.hero.title": "Acesse modelos confiaveis e otimizados para agentes de codigo",
  "zen.hero.body":
    "O Zen te da acesso a um conjunto selecionado de modelos de IA que a Terminal Agent testou e benchmarkou especificamente para agentes de codigo. Nao precisa se preocupar com desempenho e qualidade inconsistentes entre provedores: use modelos validados que funcionam.",

  "zen.faq.q1": "O que e Terminal Agent Zen?",
  "zen.faq.a1":
    "Zen e um conjunto selecionado de modelos de IA testados e benchmarkados para agentes de codigo, criado pelo time por tras do Terminal Agent.",
  ...
  "zen.faq.a3":
    "Zen nao tem fins lucrativos. Zen repassa os custos dos provedores de modelos diretamente para voce. Quanto maior o uso do Zen, mais a Terminal Agent pode negociar melhores taxas e repassar para voce.",
  ...
  "zen.faq.a4.p3":
    "Para cobrir custos, a Terminal Agent adiciona apenas uma pequena taxa de processamento de pagamento de $1.23 por recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Embora o Zen funcione muito bem com o Terminal Agent, voce pode usar o Zen com qualquer agente. Siga as instrucoes de configuracao no seu agente de codigo preferido.",
  ...
  "zen.problem.subtitle": "Estamos corrigindo isso para todos, não apenas para os usuários Terminal Agent.",
  ...
  "zen.how.body": "Embora sugerimos que você use Zen com Terminal Agent, você pode usar Zen com qualquer agente.",
  ...
  "download.meta.description": "Baixe o Terminal Agent para macOS, Windows e Linux",
  "download.hero.title": "Baixar Terminal Agent",
  ...
  "download.section.extensions": "Extensoes do Terminal Agent",
  "download.section.integrations": "Integracoes do Terminal Agent",
  ...
  "download.faq.a3.beforeLocal":
    "Nao necessariamente, mas provavelmente. Voce vai precisar de uma assinatura de IA se quiser conectar o Terminal Agent a um provedor pago, embora possa trabalhar com",
  ...
  "download.faq.a3.afterZen":
    ", o Terminal Agent funciona com todos os provedores populares como OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "Terminal Agent e 100% gratuito para usar.",
  "download.faq.a5.p2.beforeZen":
    "Qualquer custo adicional vira da sua assinatura de um provedor de modelos. Embora o Terminal Agent funcione com qualquer provedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Seus dados e informacoes so sao armazenados quando voce cria links compartilhaveis no Terminal Agent.",
  "download.faq.a6.p2.beforeShare": "Saiba mais sobre",
  "download.faq.a6.shareLink": "paginas de compartilhamento",

  "enterprise.title": "Terminal Agent | Solucoes empresariais para sua organizacao",
  "enterprise.meta.description": "Entre em contato com a Terminal Agent para solucoes empresariais",
  "enterprise.hero.title": "Seu codigo e seu",
  "enterprise.hero.body1":
    "A Terminal Agent opera de forma segura dentro da sua organizacao sem armazenar dados ou contexto e sem restricoes de licenca ou reivindicacoes de propriedade. Inicie um teste com sua equipe e, em seguida, implante em toda a organizacao integrando com seu SSO e gateway interno de IA.",
  ...
  "enterprise.faq.q1": "O que e Terminal Agent Enterprise?",
  "enterprise.faq.a1":
    "Terminal Agent Enterprise e para organizacoes que querem garantir que seu codigo e dados nunca saiam da sua infraestrutura. Isso pode ser feito com uma configuracao centralizada que se integra ao seu SSO e gateway interno de IA.",
  "enterprise.faq.q2": "Como comeco com Terminal Agent Enterprise?",
  "enterprise.faq.a2":
    "Basta comecar com um teste interno com sua equipe. A Terminal Agent por padrao nao armazena seu codigo nem dados de contexto, tornando facil comecar. Depois, entre em contato conosco para discutir precos e opcoes de implementacao.",
  ...
  "enterprise.faq.q4": "Meus dados estao seguros com Terminal Agent Enterprise?",
  "enterprise.faq.a4":
    "Sim. A Terminal Agent nao armazena seu codigo nem dados de contexto. Todo o processamento acontece localmente ou por chamadas diretas de API ao seu provedor de IA. Com configuracao centralizada e integracao SSO, seus dados permanecem seguros dentro da infraestrutura da sua organizacao.",

  "brand.title": "Terminal Agent | Marca",
  "brand.meta.description": "Diretrizes de marca da Terminal Agent",
  "brand.heading": "Diretrizes de marca",
  "brand.subtitle": "Recursos e arquivos para ajudar você a trabalhar com a marca Terminal Agent.",
  "brand.downloadAll": "Baixar todos os assets",
  "changelog.title": "Terminal Agent | Registro de mudancas",
  "changelog.meta.description": "Notas de versao e registro de mudancas do Terminal Agent",
  "changelog.hero.title": "Registro de mudancas",
  "changelog.hero.subtitle": "Novas atualizacoes e melhorias no Terminal Agent",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen com qualquer agente de codificação e continue usando outros provedores com zeroxzero sempre que quiser.",
  ...
  "workspace.newUser.step.login.after": "e selecione zeroxzero",
  "workspace.newUser.step.pasteKey": "Cole sua chave API",
  "workspace.newUser.step.models.before": "Inicie zeroxzero e execute",
  ...
  "workspace.keys.subtitle": "Gerencie suas chaves API para acessar serviços zeroxzero.",
  "workspace.keys.create": "Criar chave API",
  "workspace.keys.placeholder": "Digite o nome da chave",
  "workspace.keys.empty": "Crie uma chave zeroxzero Gateway API",
  ...
  "workspace.black.subscription.message": "Você está inscrito no Terminal Agent Black por ${{plan}} por mês.",
