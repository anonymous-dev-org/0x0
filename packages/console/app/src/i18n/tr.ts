...
export const dict = {
  ...
  "notFound.title": "Bulunamadi | zeroxzero",
  ...
  "home.title": "Terminal Agent | Acik kaynakli yapay zeka kodlama ajani",
  ...
  "home.what.title": "Terminal Agent nedir?",
  "home.what.body":
    "Terminal Agent, terminalinizde, IDE'nizde veya masaustunde kod yazmaniza yardim eden acik kaynakli bir ajandir.",
  ...
  "home.growth.body":
    "GitHub'da <strong>{{stars}}</strong>+ yildiz, <strong>{{contributors}}</strong> katilimci ve <strong>{{commits}}</strong>+ commit ile Terminal Agent, her ay <strong>{{monthlyUsers}}</strong>+ gelistirici tarafindan kullaniliyor ve guveniliyor.",
  ...
  "home.privacy.body":
    "Terminal Agent kodunuzu veya baglam verilerinizi saklamaz; bu sayede gizlilige duyarli ortamlarda calisabilir.",
  "home.privacy.learnMore": "Hakkinda daha fazla bilgi:",
  "home.privacy.link": "gizlilik",

  "home.faq.q1": "Terminal Agent nedir?",
  "home.faq.a1":
    "Terminal Agent, herhangi bir AI modeliyle kod yazmaniza ve calistirmaniza yardim eden acik kaynakli bir ajandir. Terminal arayuzu, masaustu uygulamasi veya IDE uzantisi olarak kullanilabilir.",
  "home.faq.q2": "Terminal Agent'u nasil kullanirim?",
  "home.faq.a2.before": "Baslamanin en kolay yolu",
  "home.faq.a2.link": "girisi okumaktir",
  "home.faq.q3": "Terminal Agent icin ek AI aboneliklerine ihtiyacim var mi?",
  ...
  "home.faq.a4.p1":
    "Evet. Terminal Agent tum buyuk saglayicilarin aboneliklerini destekler. Claude Pro/Max, ChatGPT Plus/Pro veya GitHub Copilot kullanabilirsiniz.",
  "home.faq.q5": "Terminal Agent'u sadece terminalde mi kullanabilirim?",
  "home.faq.a5.beforeDesktop": "Artik hayir! Terminal Agent simdi",
  "home.faq.a5.desktop": "masaustu",
  "home.faq.a5.and": "ve",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Terminal Agent ne kadar?",
  "home.faq.a6":
    "Terminal Agent %100 ucretsizdir. Ayrica ucretsiz model setiyle gelir. Baska bir saglayici baglarsaniz ek maliyetler olabilir.",
  ...
  "home.faq.q8": "Terminal Agent acik kaynak mi?",
  "home.faq.a8.p1": "Evet, Terminal Agent tamamen acik kaynaktir. Kaynak kodu",
  ...
  "home.zenCta.body":
    "Zen, Terminal Agent'un kodlama ajanlari icin ozel olarak test edip benchmark ettigi secilmis AI modellerine erisim saglar. Saglayicilar arasinda tutarsiz performans ve kalite konusunda endiselenmeyin; calisan, dogrulanmis modelleri kullanin.",
  "home.zenCta.link": "Zen hakkinda",

  "download.title": "Terminal Agent | Indir",

  "zen.title": "Terminal Agent Zen | Kodlama ajanlari icin guvenilir, optimize edilmis modellerin secilmis seti",
  "zen.hero.title": "Kodlama ajanlari icin guvenilir, optimize modeller",
  "zen.hero.body":
    "Zen, Terminal Agent'un kodlama ajanlari icin ozel olarak test edip benchmark ettigi secilmis AI modellerine erisim saglar. Saglayicilar arasinda tutarsiz performans ve kalite konusunda endiselenmeyin; calisan, dogrulanmis modelleri kullanin.",

  "zen.faq.q1": "Terminal Agent Zen nedir?",
  "zen.faq.a1":
    "Zen, Terminal Agent ekibi tarafindan olusturulan ve kodlama ajanlari icin test edilip benchmark edilen secilmis bir AI model setidir.",
  ...
  "zen.faq.a3":
    "Zen kar amacli degildir. Zen, model saglayicilarinin maliyetlerini size yansitir. Zen'in kullanimi arttikca Terminal Agent daha iyi fiyatlar pazarlayabilir ve bunlari size yansitabilir.",
  ...
  "zen.faq.a4.p3":
    "Maliyetleri karsilamak icin Terminal Agent, $20 bakiye yuklemesi basina yalnizca $1.23 tutarinda kucuk bir odeme isleme ucreti ekler.",
  ...
  "zen.faq.a8":
    "Zen Terminal Agent ile harika calisir, ama Zen'i herhangi bir ajan ile kullanabilirsiniz. Tercih ettiginiz kodlama ajaninda kurulum talimatlarini izleyin.",
  ...
  "zen.problem.subtitle": "Bu sorunu yalnızca Terminal Agent kullanıcıları için değil, herkes için düzeltiyoruz.",
  ...
  "zen.how.body": "Zen'yi Terminal Agent ile kullanmanızı önersek de, Zen'yi herhangi bir aracıyla kullanabilirsiniz.",
  ...
  "download.meta.description": "Terminal Agent'u macOS, Windows ve Linux icin indir",
  "download.hero.title": "Terminal Agent'u indir",
  ...
  "download.section.extensions": "Terminal Agent Eklentileri",
  "download.section.integrations": "Terminal Agent Entegrasyonlari",
  ...
  "download.faq.a3.beforeLocal":
    "Tam olarak degil, ama muhtemelen. Terminal Agent'u ucretli bir saglayiciya baglamak istiyorsaniz bir AI aboneligi gerekir, ancak",
  ...
  "download.faq.a3.afterZen":
    " kullanmaya tesvik ediyoruz, ancak Terminal Agent OpenAI, Anthropic, xAI vb. gibi tum populer saglayicilarla calisir.",

  "download.faq.a5.p1": "Terminal Agent %100 ucretsizdir.",
  "download.faq.a5.p2.beforeZen":
    "Ek maliyetler, bir model saglayicisina olan aboneliginizden gelir. Terminal Agent herhangi bir model saglayicisiyla calisir, ancak",
  "download.faq.a5.p2.afterZen": " kullanmanizi oneririz.",

  "download.faq.a6.p1":
    "Verileriniz ve bilginiz yalnizca Terminal Agent'da paylasilabilir baglantilar olusturdugunuzda saklanir.",
  "download.faq.a6.p2.beforeShare": "Daha fazla bilgi:",
  "download.faq.a6.shareLink": "paylasim sayfalari",

  "enterprise.title": "Terminal Agent | Kurumunuz icin kurumsal cozumler",
  "enterprise.meta.description": "Kurumsal cozumler icin Terminal Agent ile iletisime gecin",
  "enterprise.hero.title": "Kodunuz size aittir",
  "enterprise.hero.body1":
    "Terminal Agent, hicbir veri veya baglam saklamadan ve lisans kisitlamalari ya da sahiplik iddialari olmadan kurulusunuzun icinde guvenli sekilde calisir. Ekibinizle bir deneme baslatin, ardindan SSO'nuz ve dahili AI gecidiniz ile entegre ederek tum kurulusunuzda devreye alin.",
  ...
  "enterprise.faq.q1": "Terminal Agent Enterprise nedir?",
  "enterprise.faq.a1":
    "Terminal Agent Enterprise, kodunuzun ve verilerinizin asla altyapinizi terk etmemesini saglamak isteyen kurumlar icindir. Bunu, SSO'nuz ve dahili AI gecidiniz ile entegre olan merkezilestirilmis bir konfigurasyonla saglar.",
  "enterprise.faq.q2": "Terminal Agent Enterprise'a nasil baslarim?",
  "enterprise.faq.a2":
    "Ekibinizle dahili bir deneme ile baslayin. Terminal Agent varsayilan olarak kodunuzu veya baglam verilerinizi saklamaz, bu da baslamayi kolaylastirir. Ardindan fiyatlandirma ve uygulama seceneklerini gorusmek icin bize ulasin.",
  ...
  "enterprise.faq.q4": "Terminal Agent Enterprise ile verilerim guvende mi?",
  "enterprise.faq.a4":
    "Evet. Terminal Agent kodunuzu veya baglam verilerinizi saklamaz. Tum isleme yerel olarak ya da AI saglayiciniza dogrudan API cagirilari ile gerceklestirilir. Merkezilestirilmis konfigurasyon ve SSO entegrasyonu ile verileriniz kurumunuzun altyapisi icinde guvende kalir.",

  "brand.title": "Terminal Agent | Marka",
  "brand.meta.description": "Terminal Agent marka kilavuzu",
  "brand.heading": "Marka kilavuzu",
  "brand.subtitle": "Terminal Agent markasi ile calismaniza yardimci olacak kaynaklar ve varliklar.",
  "brand.downloadAll": "Tum varliklari indir",
  "changelog.title": "Terminal Agent | Degisiklik gunlugu",
  "changelog.meta.description": "Terminal Agent surum notlari ve degisiklik gunlugu",
  "changelog.hero.title": "Degisiklik gunlugu",
  "changelog.hero.subtitle": "Terminal Agent icin yeni guncellemeler ve iyilestirmeler",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen'i herhangi bir kodlama aracısıyla kullanın ve istediğiniz zaman zeroxzero ile diğer sağlayıcıları kullanmaya devam edin.",
  ...
  "workspace.newUser.step.login.after": "ve zeroxzero seçeneğini seçin",
  "workspace.newUser.step.pasteKey": "API anahtarınızı yapıştırın",
  "workspace.newUser.step.models.before": "zeroxzero başlatın ve çalıştırın",
  ...
  "workspace.keys.subtitle": "zeroxzero hizmetlerine erişim için API anahtarlarınızı yönetin.",
  "workspace.keys.create": "API Anahtarı Oluşturun",
  "workspace.keys.placeholder": "Anahtar adını girin",
  "workspace.keys.empty": "Bir zeroxzero Ağ Geçidi API anahtarı oluşturun",
  ...
  "workspace.black.subscription.message": "Aylık {{plan}} karşılığında Terminal Agent Black'e abonesiniz.",
  ...
  "workspace.black.waitlist.joined": "Aylık ${{plan}} Terminal Agent Black planı için bekleme listesindesiniz.",
  "workspace.black.waitlist.ready": "Sizi ayda {{plan}} $ tutarındaki Terminal Agent Black planına kaydetmeye hazırız.",
