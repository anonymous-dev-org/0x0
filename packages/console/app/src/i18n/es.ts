...
export const dict = {
  ...
  "notFound.title": "No encontrado | zeroxzero",
  ...
  "home.title": "Terminal Agent | El agente de codificacion con IA de codigo abierto",
  ...
  "home.what.title": "Que es Terminal Agent?",
  "home.what.body":
    "Terminal Agent es un agente de codigo abierto que te ayuda a escribir codigo en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con mas de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y mas de <strong>{{commits}}</strong> commits, Terminal Agent es usado y confiado por mas de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "Terminal Agent no almacena tu codigo ni datos de contexto, para poder operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Mas informacion sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "Que es Terminal Agent?",
  "home.faq.a1":
    "Terminal Agent es un agente de codigo abierto que te ayuda a escribir y ejecutar codigo con cualquier modelo de IA. Esta disponible como interfaz de terminal, app de escritorio o extension de IDE.",
  "home.faq.q2": "Como uso Terminal Agent?",
  "home.faq.a2.before": "La forma mas facil de empezar es leer la",
  "home.faq.a2.link": "introduccion",
  "home.faq.q3": "Necesito suscripciones extra de IA para usar Terminal Agent?",
  "home.faq.a3.p1":
    "No necesariamente: Terminal Agent incluye un conjunto de modelos gratis que puedes usar sin crear una cuenta.",
  "home.faq.a3.p2.beforeZen": "Ademas, puedes usar modelos populares para codigo creando una cuenta de",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Aunque alentamos a los usuarios a usar Zen, Terminal Agent tambien funciona con los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "Puedo usar mis suscripciones de IA existentes con Terminal Agent?",
  "home.faq.a4.p1":
    "Si, Terminal Agent admite planes de suscripcion de los principales proveedores. Puedes usar Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Solo puedo usar Terminal Agent en la terminal?",
  "home.faq.a5.beforeDesktop": "Ya no! Terminal Agent ahora esta disponible como una app para",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Cuanto cuesta Terminal Agent?",
  "home.faq.a6":
    "Terminal Agent es 100% gratis. Tambien incluye modelos gratuitos. Puede haber costos adicionales si conectas otro proveedor.",
  ...
  "home.faq.q8": "Terminal Agent es de codigo abierto?",
  "home.faq.a8.p1": "Si, Terminal Agent es totalmente open source. El codigo fuente es publico en",
  ...
  "zen.faq.q1": "Que es Terminal Agent Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y benchmarkeados para agentes de codigo, creado por el equipo detras de Terminal Agent.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen traslada los costos de los proveedores de modelos directamente a ti. Cuanto mas uso tenga Zen, mas puede Terminal Agent negociar mejores tarifas y trasladartelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, Terminal Agent solo agrega una pequena tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona muy bien con Terminal Agent, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuracion en tu agente preferido.",
  ...
  "zen.problem.subtitle": "Estamos solucionando este problema para todos, no solo para los usuarios de Terminal Agent.",
  ...
  "zen.how.body": "Si bien le sugerimos que utilice Zen con Terminal Agent, puede utilizar Zen con cualquier agente.",
  ...
  "download.meta.description": "Descarga Terminal Agent para macOS, Windows y Linux",
  "download.hero.title": "Descargar Terminal Agent",
  ...
  "download.section.extensions": "Extensiones de Terminal Agent",
  "download.section.integrations": "Integraciones de Terminal Agent",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitaras una suscripcion de IA si quieres conectar Terminal Agent a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", Terminal Agent funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "Terminal Agent es 100% gratis.",
  ...
  "enterprise.title": "Terminal Agent | Soluciones empresariales para tu organizacion",
  "enterprise.meta.description": "Contacta a Terminal Agent para soluciones empresariales",
  "enterprise.hero.title": "Tu codigo es tuyo",
  "enterprise.hero.body1":
    "Terminal Agent opera de forma segura dentro de tu organizacion sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo y luego despliegalo en toda tu organizacion integrandolo con tu SSO y tu gateway interno de IA.",
  ...
  "enterprise.faq.q1": "Que es Terminal Agent Enterprise?",
  "enterprise.faq.a1":
    "Terminal Agent Enterprise es para organizaciones que quieren asegurarse de que su codigo y datos nunca salgan de su infraestructura. Puede lograrlo mediante una configuracion centralizada que se integra con tu SSO y tu gateway interno de IA/LLM.",
  "enterprise.faq.q2": "Como empiezo con Terminal Agent Enterprise?",
  "enterprise.faq.a2":
    "Empieza con una prueba interna con tu equipo. Terminal Agent por defecto no almacena tu codigo ni datos de contexto, lo que facilita comenzar. Despues, contactanos para hablar sobre precios y opciones de implementacion.",
  ...
  "enterprise.faq.q4": "Mis datos estan seguros con Terminal Agent Enterprise?",
  "enterprise.faq.a4":
    "Si. Terminal Agent no almacena tu codigo ni datos de contexto. Todo el procesamiento ocurre localmente o mediante llamadas directas a la API de tu proveedor de IA. Con configuracion centralizada e integracion SSO, tus datos permanecen seguros dentro de la infraestructura de tu organizacion.",

  "brand.title": "Terminal Agent | Marca",
  "brand.meta.description": "Guia de marca de Terminal Agent",
  "brand.heading": "Guia de marca",
  "brand.subtitle": "Recursos y materiales para ayudarte a trabajar con la marca Terminal Agent.",
  "brand.downloadAll": "Descargar todos los recursos",
  "changelog.title": "Terminal Agent | Registro de cambios",
  "changelog.meta.description": "Notas de version y registro de cambios de Terminal Agent",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras de Terminal Agent",
  ...
  "workspace.newUser.feature.lockin.body":
    "Utilice Zen con cualquier agente de codificación y continúe utilizando otros proveedores con zeroxzero cuando lo desee.",
  ...
  "workspace.newUser.step.login.after": "y seleccione zeroxzero",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicie zeroxzero y ejecute",
  ...
  "workspace.keys.subtitle": "Administre sus claves API para acceder a los servicios zeroxzero.",
  "workspace.keys.create": "Crear clave API",
  "workspace.keys.placeholder": "Introduzca el nombre de la clave",
  "workspace.keys.empty": "Cree una clave zeroxzero de puerta de enlace API",
  ...
  "workspace.black.subscription.message": "Estás suscrito a Terminal Agent Black por ${{plan}} al mes.",
