...
export const dict = {
  ...
  "notFound.title": "Ikke fundet | zeroxzero",
  ...
  "home.title": "Terminal Agent | Den open source AI-kodningsagent",
  ...
  "home.what.title": "Hvad er Terminal Agent?",
  "home.what.body":
    "Terminal Agent er en open source agent, der hjelper dig med at skrive kode i din terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsydere og over <strong>{{commits}}</strong> commits bruges Terminal Agent af over <strong>{{monthlyUsers}}</strong> udviklere hver maaned.",
  ...
  "home.privacy.body":
    "Terminal Agent gemmer ikke din kode eller kontekstdata, sa den kan bruges i privatlivsfomlsomme miljoer.",
  "home.privacy.learnMore": "Laes mere om",
  "home.privacy.link": "privatliv",

  "home.faq.q1": "Hvad er Terminal Agent?",
  "home.faq.a1":
    "Terminal Agent er en open source agent, der hjelper dig med at skrive og kore kode med enhver AI-model. Den er tilgengelig som terminal-interface, desktop-app eller IDE-udvidelse.",
  "home.faq.q2": "Hvordan bruger jeg Terminal Agent?",
  "home.faq.a2.before": "Den nemmeste made at komme i gang pa er at laese",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Skal jeg have ekstra AI-abonnementer for at bruge Terminal Agent?",
  "home.faq.a3.p1":
    "Ikke nodvendigvis. Terminal Agent kommer med gratis modeller, som du kan bruge uden at oprette en konto.",
  "home.faq.a3.p2.beforeZen": "Derudover kan du bruge populære kodningsmodeller ved at oprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi opfordrer til at bruge Zen, men Terminal Agent virker ogsa med populære udbydere som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan endda forbinde dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruge mine eksisterende AI-abonnementer med Terminal Agent?",
  "home.faq.a4.p1":
    "Ja. Terminal Agent understotter abonnementer fra alle store udbydere. Du kan bruge Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot.",
  "home.faq.q5": "Kan jeg kun bruge Terminal Agent i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke længere! Terminal Agent er nu tilgengelig som en app til",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hvad koster Terminal Agent?",
  "home.faq.a6":
    "Terminal Agent er 100% gratis at bruge. Det kommer ogsa med et saet gratis modeller. Der kan vare ekstra omkostninger, hvis du forbinder en anden udbyder.",
  ...
  "home.faq.q8": "Er Terminal Agent open source?",
  "home.faq.a8.p1": "Ja, Terminal Agent er fuldt open source. Kildekoden er offentlig pa",
  ...
  "home.zenCta.body":
    "Zen giver dig adgang til et handplukket sæt AI-modeller, som Terminal Agent har testet og benchmarked specifikt til kodningsagenter. Du behøver ikke bekymre dig om svingende performance og kvalitet pa tværs af udbydere: brug validerede modeller, der virker.",
  "home.zenCta.link": "Laes om Zen",

  "download.title": "Terminal Agent | Download",

  "zen.title": "Terminal Agent Zen | Et kurateret saet af palidelige, optimerede modeller til kodningsagenter",
  "zen.hero.title": "Fa adgang til palidelige, optimerede modeller til kodningsagenter",
  "zen.hero.body":
    "Zen giver dig adgang til et handplukket sæt AI-modeller, som Terminal Agent har testet og benchmarked specifikt til kodningsagenter. Du behøver ikke bekymre dig om svingende performance og kvalitet pa tværs af udbydere: brug validerede modeller, der virker.",

  "zen.faq.q1": "Hvad er Terminal Agent Zen?",
  "zen.faq.a1":
    "Zen er et kurateret saet AI-modeller testet og benchmarked til kodningsagenter, skabt af teamet bag Terminal Agent.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profit. Zen viderefakturerer omkostningerne fra modeludbyderne til dig. Jo mere Zen bruges, desto mere kan Terminal Agent forhandle bedre priser og give dem videre til dig.",
  ...
  "zen.faq.a4.p3":
    "For at daekke omkostninger tilfojer Terminal Agent kun et lille betalingsgebyr pa $1.23 per $20 saldo-opfyldning.",
  ...
  "zen.faq.a8":
    "Selvom Zen fungerer godt med Terminal Agent, kan du bruge Zen med enhver agent. Folg opsaetningsinstruktionerne i din foretrukne kodningsagent.",
  ...
  "zen.problem.subtitle": "Vi løser dette for alle, ikke kun Terminal Agent-brugere.",
  ...
  "zen.how.body": "Selvom vi foreslår, at du bruger Zen med Terminal Agent, kan du bruge Zen med enhver agent.",
  ...
  "download.meta.description": "Download Terminal Agent til macOS, Windows og Linux",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nodvendigvis, men sandsynligvis. Du skal bruge et AI-abonnement hvis du vil forbinde Terminal Agent til en betalt udbyder, men du kan arbejde med",
  ...
  "download.faq.a3.afterZen": ", fungerer Terminal Agent med alle populære udbydere som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "Terminal Agent er 100% gratis at bruge.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra omkostninger kommer fra dit abonnement hos en modeludbyder. Selvom Terminal Agent fungerer med enhver modeludbyder, anbefaler vi at bruge",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dine data og oplysninger gemmes kun når du opretter delbare links i Terminal Agent.",
  "download.faq.a6.p2.beforeShare": "Laes mere om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "Terminal Agent | Enterprise-løsninger til din organisation",
  "enterprise.meta.description": "Kontakt Terminal Agent for enterprise-løsninger",
  "enterprise.hero.title": "Din kode er din egen",
  "enterprise.hero.body1":
    "Terminal Agent fungerer sikkert inde i din organisation uden at lagre data eller kontekst og uden licensbegrænsninger eller ejerskabskrav. Start en prøveperiode med dit team, og udrul det derefter i hele din organisation ved at integrere det med dit SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hvad er Terminal Agent Enterprise?",
  "enterprise.faq.a1":
    "Terminal Agent Enterprise er til organisationer, der vil sikre, at deres kode og data aldrig forlader deres infrastruktur. Det kan gøres med en central konfiguration, der integrerer med dit SSO og din interne AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med Terminal Agent Enterprise?",
  "enterprise.faq.a2":
    "Start blot med en intern prøveperiode med dit team. Terminal Agent gemmer som standard ikke din kode eller kontekstdata, hvilket gør det nemt at komme i gang. Kontakt os derefter for at tale om priser og implementeringsmuligheder.",
  ...
  "enterprise.faq.q4": "Er mine data sikre med Terminal Agent Enterprise?",
  "enterprise.faq.a4":
    "Ja. Terminal Agent gemmer ikke din kode eller kontekstdata. Al behandling sker lokalt eller via direkte API-kald til din AI-udbyder. Med central konfiguration og SSO-integration forbliver dine data sikre inden for din organisations infrastruktur.",

  "brand.title": "Terminal Agent | Brand",
  "brand.meta.description": "Terminal Agent brandretningslinjer",
  "brand.heading": "Brandretningslinjer",
  "brand.subtitle": "Ressourcer og assets, der hjelper dig med at arbejde med Terminal Agent-brandet.",
  "brand.downloadAll": "Download alle assets",
  "changelog.title": "Terminal Agent | Changelog",
  "changelog.meta.description": "Terminal Agent versionsnoter og changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nye opdateringer og forbedringer til Terminal Agent",
  ...
  "workspace.newUser.feature.lockin.body":
    "Brug Zen med en hvilken som helst kodningsagent, og fortsæt med at bruge andre udbydere med zeroxzero, når du vil.",
  ...
  "workspace.newUser.step.login.after": "og vælg zeroxzero",
  "workspace.newUser.step.pasteKey": "Indsæt din API nøgle",
  "workspace.newUser.step.models.before": "Start zeroxzero og kør",
  ...
  "workspace.keys.subtitle": "Administrer dine API nøgler for at få adgang til zeroxzero tjenester.",
  "workspace.keys.create": "Opret API nøgle",
  "workspace.keys.placeholder": "Indtast nøglenavn",
  "workspace.keys.empty": "Opret en zeroxzero Gateway API nøgle",
  ...
  "workspace.black.subscription.message": "Du abonnerer på Terminal Agent Black for ${{plan}} om måneden.",
  ...
  "workspace.black.waitlist.joined": "Du er på ventelisten for ${{plan}} per måned Terminal Agent Black plan.",
  "workspace.black.waitlist.ready": "Vi er klar til at tilmelde dig ${{plan}} per måned Terminal Agent Black plan.",
