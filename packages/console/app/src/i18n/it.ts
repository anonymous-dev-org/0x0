...
export const dict = {
  ...
  "notFound.title": "Non trovato | zeroxzero",
  ...
  "home.title": "Terminal Agent | L'agente di coding IA open source",
  ...
  "home.growth.body":
    "Con oltre <strong>{{stars}}</strong> stelle su GitHub, <strong>{{contributors}}</strong> contributori e oltre <strong>{{commits}}</strong> commit, Terminal Agent e usato e apprezzato da oltre <strong>{{monthlyUsers}}</strong> sviluppatori ogni mese.",
  ...
  "home.privacy.body":
    "Terminal Agent non archivia il tuo codice ne i dati di contesto, cosi puo operare in ambienti sensibili alla privacy.",
  "home.privacy.learnMore": "Scopri di piu su",
  "home.privacy.link": "privacy",

  "home.faq.q1": "Che cos'e Terminal Agent?",
  "home.faq.a1":
    "Terminal Agent e un agente open source che ti aiuta a scrivere ed eseguire codice con qualsiasi modello di IA. E disponibile come interfaccia terminale, app desktop o estensione IDE.",
  "home.faq.q2": "Come uso Terminal Agent?",
  "home.faq.a2.before": "Il modo piu semplice per iniziare e leggere l'",
  "home.faq.a2.link": "introduzione",
  "home.faq.q3": "Mi servono abbonamenti IA extra per usare Terminal Agent?",
  "home.faq.a3.p1":
    "Non necessariamente: Terminal Agent include un set di modelli gratuiti che puoi usare senza creare un account.",
  "home.faq.a3.p2.beforeZen": "Inoltre, puoi usare modelli popolari per il coding creando un account",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Anche se incoraggiamo gli utenti a usare Zen, Terminal Agent funziona anche con i provider piu diffusi come OpenAI, Anthropic, xAI, ecc.",
  "home.faq.a3.p4.beforeLocal": "Puoi anche collegare i tuoi",
  "home.faq.a3.p4.localLink": "modelli locali",
  "home.faq.q4": "Posso usare i miei abbonamenti IA esistenti con Terminal Agent?",
  "home.faq.a4.p1":
    "Si, Terminal Agent supporta gli abbonamenti dei principali provider. Puoi usare Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Posso usare Terminal Agent solo nel terminale?",
  "home.faq.a5.beforeDesktop": "Non piu! Terminal Agent ora e disponibile come app per",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto costa Terminal Agent?",
  "home.faq.a6":
    "Terminal Agent e gratuito al 100%. Include anche un set di modelli gratuiti. Potrebbero esserci costi aggiuntivi se colleghi altri provider.",
  ...
  "home.faq.q8": "Terminal Agent e open source?",
  "home.faq.a8.p1": "Si, Terminal Agent e completamente open source. Il codice sorgente e pubblico su",
  ...
  "home.zenCta.body":
    "Zen ti da accesso a una selezione di modelli di IA che Terminal Agent ha testato e benchmarkato specificamente per agenti di coding. Niente piu preoccupazioni per prestazioni e qualita incoerenti tra provider: usa modelli validati che funzionano.",
  "home.zenCta.link": "Scopri Zen",

  "download.title": "Terminal Agent | Download",

  "zen.title": "Terminal Agent Zen | Una selezione curata di modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.title": "Accedi a modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.body":
    "Zen ti da accesso a una selezione di modelli di IA che Terminal Agent ha testato e benchmarkato specificamente per agenti di coding. Niente piu preoccupazioni per prestazioni e qualita incoerenti tra provider: usa modelli validati che funzionano.",

  "zen.faq.q1": "Cos'e Terminal Agent Zen?",
  "zen.faq.a1":
    "Zen e un set curato di modelli di IA testati e benchmarkati per agenti di coding, creato dal team dietro Terminal Agent.",
  ...
  "zen.faq.a3":
    "Zen non e a scopo di lucro. Zen ribalta i costi dei provider di modelli direttamente su di te. Piu Zen viene usato, piu Terminal Agent puo negoziare tariffe migliori e passarle a te.",
  ...
  "zen.faq.a4.p3":
    "Per coprire i costi, Terminal Agent aggiunge solo una piccola commissione di elaborazione del pagamento di $1.23 per ogni ricarica di saldo da $20.",
  ...
  "zen.faq.a8":
    "Anche se Zen funziona alla grande con Terminal Agent, puoi usare Zen con qualsiasi agente. Segui le istruzioni di configurazione nel tuo agente di coding preferito.",
  ...
  "zen.problem.subtitle": "Stiamo risolvendo questo problema per tutti, non solo per gli utenti Terminal Agent.",
  ...
  "download.meta.description": "Scarica Terminal Agent per macOS, Windows e Linux",
  "download.hero.title": "Scarica Terminal Agent",
  ...
  "download.section.extensions": "Estensioni Terminal Agent",
  "download.section.integrations": "Integrazioni Terminal Agent",
  ...
  "download.faq.a5.p2.beforeZen":
    "Eventuali costi aggiuntivi dipendono dal tuo abbonamento a un provider di modelli. Anche se Terminal Agent funziona con qualsiasi provider, consigliamo di usare",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "I tuoi dati e le tue informazioni vengono archiviati solo quando crei link condivisibili in Terminal Agent.",
  "download.faq.a6.p2.beforeShare": "Scopri di piu su",
  "download.faq.a6.shareLink": "le pagine di condivisione",

  "enterprise.title": "Terminal Agent | Soluzioni enterprise per la tua organizzazione",
  "enterprise.meta.description": "Contatta Terminal Agent per soluzioni enterprise",
  "enterprise.hero.title": "Il tuo codice e tuo",
  "enterprise.hero.body1":
    "Terminal Agent opera in modo sicuro all'interno della tua organizzazione senza archiviare dati o contesto e senza restrizioni di licenza o rivendicazioni di proprieta. Avvia una prova con il tuo team, poi distribuiscilo in tutta l'organizzazione integrandolo con il tuo SSO e il tuo gateway IA interno.",
  ...
  "enterprise.faq.q1": "Cos'e Terminal Agent Enterprise?",
  "enterprise.faq.a1":
    "Terminal Agent Enterprise e pensato per le organizzazioni che vogliono assicurarsi che il loro codice e i loro dati non lascino mai la propria infrastruttura. Lo fa tramite una configurazione centralizzata che si integra con il tuo SSO e il tuo gateway IA interno.",
  "enterprise.faq.q2": "Come posso iniziare con Terminal Agent Enterprise?",
  "enterprise.faq.a2":
    "Inizia semplicemente con una prova interna con il tuo team. Terminal Agent, per impostazione predefinita, non archivia il tuo codice ne i dati di contesto, rendendo facile partire. Poi contattaci per discutere prezzi e opzioni di implementazione.",
  ...
  "enterprise.faq.q4": "I miei dati sono al sicuro con Terminal Agent Enterprise?",
  "enterprise.faq.a4":
    "Si. Terminal Agent non archivia il tuo codice ne i dati di contesto. Tutta l'elaborazione avviene localmente o tramite chiamate API dirette al tuo provider di IA. Con configurazione centralizzata e integrazione SSO, i tuoi dati rimangono al sicuro all'interno dell'infrastruttura della tua organizzazione.",

  "brand.title": "Terminal Agent | Brand",
  "brand.meta.description": "Linee guida del brand Terminal Agent",
  "brand.heading": "Linee guida del brand",
  "brand.subtitle": "Risorse e asset per aiutarti a lavorare con il brand Terminal Agent.",
  "brand.downloadAll": "Scarica tutti gli asset",
  "changelog.title": "Terminal Agent | Changelog",
  "changelog.meta.description": "Note di rilascio e changelog di Terminal Agent",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nuovi aggiornamenti e miglioramenti per Terminal Agent",
  ...
  "workspace.newUser.feature.lockin.body":
    "Utilizza Zen con qualsiasi agente di codifica e continua a utilizzare altri provider con zeroxzero ogni volta che vuoi.",
  ...
  "workspace.newUser.step.login.after": "e seleziona zeroxzero",
  "workspace.newUser.step.pasteKey": "Incolla la tua chiave API",
  "workspace.newUser.step.models.before": "Avvia zeroxzero ed esegui",
  ...
  "workspace.keys.subtitle": "Gestisci le tue chiavi API per accedere ai servizi zeroxzero.",
  "workspace.keys.create": "Crea chiave API",
  "workspace.keys.placeholder": "Inserisci il nome della chiave",
  "workspace.keys.empty": "Crea una chiave zeroxzero Gateway API",
  ...
  "workspace.black.subscription.message": "Sei abbonato a Terminal Agent Black per ${{plan}} al mese.",
  ...
  "workspace.black.waitlist.joined": "Sei in lista d'attesa per il piano nero ${{plan}} al mese Terminal Agent.",
  "workspace.black.waitlist.ready": "Siamo pronti per iscriverti al piano Terminal Agent Black da ${{plan}} al mese.",
