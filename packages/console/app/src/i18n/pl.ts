...
export const dict = {
  ...
  "notFound.title": "Nie znaleziono | zeroxzero",
  ...
  "home.title": "Terminal Agent | Open source AI agent do kodowania",
  ...
  "home.what.title": "Czym jest Terminal Agent?",
  "home.what.body": "Terminal Agent to open source agent, ktory pomaga pisac kod w terminalu, IDE lub na desktopie.",
  ...
  "home.growth.body":
    "Ponad <strong>{{stars}}</strong> gwiazdek na GitHub, <strong>{{contributors}}</strong> wspoltworcow i ponad <strong>{{commits}}</strong> commitow - Terminal Agent jest uzywany i ceniony przez ponad <strong>{{monthlyUsers}}</strong> deweloperow co miesiac.",
  ...
  "home.privacy.body":
    "Terminal Agent nie przechowuje Twojego kodu ani danych kontekstowych, dzieki czemu moze dzialac w srodowiskach wrazliwych na prywatnosc.",
  "home.privacy.learnMore": "Dowiedz sie wiecej o",
  "home.privacy.link": "prywatnosci",

  "home.faq.q1": "Czym jest Terminal Agent?",
  "home.faq.a1":
    "Terminal Agent to open source agent, ktory pomaga pisac i uruchamiac kod z dowolnym modelem AI. Jest dostepny jako interfejs terminalowy, aplikacja desktopowa lub rozszerzenie IDE.",
  "home.faq.q2": "Jak korzystac z Terminal Agent?",
  "home.faq.a2.before": "Najlatwiej zaczac od przeczytania",
  "home.faq.a2.link": "wprowadzenia",
  "home.faq.q3": "Czy potrzebuje dodatkowych subskrypcji AI, aby uzywac Terminal Agent?",
  "home.faq.a3.p1":
    "Niekoniecznie. Terminal Agent ma zestaw darmowych modeli, z ktorych mozesz korzystac bez zakladania konta.",
  "home.faq.a3.p2.beforeZen": "Poza tym mozesz uzywac popularnych modeli do kodowania tworzac konto",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Choc zachecamy do Zen, Terminal Agent dziala tez z popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itd.",
  "home.faq.a3.p4.beforeLocal": "Mozesz nawet podlaczyc swoje",
  "home.faq.a3.p4.localLink": "modele lokalne",
  "home.faq.q4": "Czy moge uzywac moich istniejacych subskrypcji AI z Terminal Agent?",
  "home.faq.a4.p1":
    "Tak. Terminal Agent wspiera subskrypcje u wszystkich glownych dostawcow. Mozesz uzywac Claude Pro/Max, ChatGPT Plus/Pro lub GitHub Copilot.",
  "home.faq.q5": "Czy moge uzywac Terminal Agent tylko w terminalu?",
  "home.faq.a5.beforeDesktop": "Juz nie! Terminal Agent jest teraz dostepny jako aplikacja na",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "i",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Ile kosztuje Terminal Agent?",
  "home.faq.a6":
    "Terminal Agent jest w 100% darmowy. Zawiera tez zestaw darmowych modeli. Moga pojawic sie dodatkowe koszty, jesli podlaczysz innego dostawce.",
  ...
  "home.faq.q8": "Czy Terminal Agent jest open source?",
  "home.faq.a8.p1": "Tak, Terminal Agent jest w pelni open source. Kod zrodlowy jest publiczny na",
  ...
  "zen.faq.q1": "Czym jest Terminal Agent Zen?",
  "zen.faq.a1":
    "Zen to wyselekcjonowany zestaw modeli AI przetestowanych i zbenchmarkowanych pod agentow kodowania, stworzony przez zespol stojacy za Terminal Agent.",
  ...
  "zen.faq.a3":
    "Zen nie jest nastawiony na zysk. Zen przekazuje koszty dostawcow modeli bezposrednio do Ciebie. Im wieksze uzycie Zen, tym bardziej Terminal Agent moze negocjowac lepsze stawki i przekazywac je Tobie.",
  ...
  "zen.faq.a4.p3":
    "Aby pokryc koszty, Terminal Agent dodaje tylko niewielka oplate za przetwarzanie platnosci w wysokosci $1.23 za kazde doladowanie salda $20.",
  ...
  "zen.faq.a8":
    "Zen swietnie dziala z Terminal Agent, ale mozesz uzywac Zen z dowolnym agentem. Postepuj zgodnie z instrukcjami konfiguracji w swoim ulubionym agencie kodowania.",
  ...
  "zen.problem.subtitle": "Naprawiamy to dla wszystkich, nie tylko dla użytkowników Terminal Agent.",
  ...
  "zen.how.body": "Chociaż sugerujemy używanie Zen z Terminal Agent, możesz używać Zen z dowolnym agentem.",
  ...
  "download.meta.description": "Pobierz Terminal Agent dla macOS, Windows i Linux",
  "download.hero.title": "Pobierz Terminal Agent",
  ...
  "download.section.extensions": "Rozszerzenia Terminal Agent",
  "download.section.integrations": "Integracje Terminal Agent",
  ...
  "download.faq.a3.beforeLocal":
    "Niekoniecznie, ale prawdopodobnie. Potrzebujesz subskrypcji AI, jesli chcesz podlaczyc Terminal Agent do platnego dostawcy, ale mozesz korzystac z",
  ...
  "download.faq.a3.afterZen":
    ", Terminal Agent dziala ze wszystkimi popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itd.",

  "download.faq.a5.p1": "Terminal Agent jest w 100% darmowy.",
  "download.faq.a5.p2.beforeZen":
    "Wszelkie dodatkowe koszty wynikaja z Twojej subskrypcji u dostawcy modeli. Terminal Agent dziala z kazdym dostawca modeli, ale polecamy korzystac z",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Twoje dane i informacje sa przechowywane tylko gdy tworzysz linki do udostepniania w Terminal Agent.",
  "download.faq.a6.p2.beforeShare": "Dowiedz sie wiecej o",
  "download.faq.a6.shareLink": "stronach udostepniania",

  "enterprise.title": "Terminal Agent | Rozwiazania enterprise dla twojej organizacji",
  "enterprise.meta.description": "Skontaktuj sie z Terminal Agent w sprawie rozwiazan enterprise",
  "enterprise.hero.title": "Twoj kod nalezy do Ciebie",
  "enterprise.hero.body1":
    "Terminal Agent dziala bezpiecznie w obrebie Twojej organizacji, nie przechowuje danych ani kontekstu oraz nie narzuca ograniczen licencyjnych ani roszczen do wlasnosci. Rozpocznij okres probny z zespolem, a nastepnie wdroz Terminal Agent w calej organizacji, integrujac go z Twoim SSO i wewnetrzna brama AI.",
  ...
  "enterprise.faq.q1": "Czym jest Terminal Agent Enterprise?",
  "enterprise.faq.a1":
    "Terminal Agent Enterprise jest dla organizacji, ktore chca miec pewnosc, ze ich kod i dane nigdy nie opuszcza ich infrastruktury. Osiaga to dzieki scentralizowanej konfiguracji, ktora integruje sie z Twoim SSO i wewnetrzna brama AI.",
  "enterprise.faq.q2": "Jak zaczac korzystac z Terminal Agent Enterprise?",
  "enterprise.faq.a2":
    "Po prostu zacznij od wewnetrznego okresu probnego z Twoim zespolem. Terminal Agent domyslnie nie przechowuje Twojego kodu ani danych kontekstowych, dzieki czemu latwo zaczac. Nastepnie skontaktuj sie z nami, aby omowic ceny i opcje wdrozenia.",
  ...
  "enterprise.faq.q4": "Czy moje dane sa bezpieczne z Terminal Agent Enterprise?",
  "enterprise.faq.a4":
    "Tak. Terminal Agent nie przechowuje Twojego kodu ani danych kontekstowych. Cale przetwarzanie odbywa sie lokalnie lub poprzez bezposrednie wywolania API do Twojego dostawcy AI. Dzieki scentralizowanej konfiguracji i integracji SSO Twoje dane pozostaja bezpieczne w obrebie infrastruktury Twojej organizacji.",

  "brand.title": "Terminal Agent | Marka",
  "brand.meta.description": "Wytyczne marki Terminal Agent",
  "brand.heading": "Wytyczne marki",
  "brand.subtitle": "Zasoby i materialy, ktore pomoga Ci pracowac z marka Terminal Agent.",
  "brand.downloadAll": "Pobierz wszystkie materialy",
  "changelog.title": "Terminal Agent | Dziennik zmian",
  "changelog.meta.description": "Informacje o wydaniach i dziennik zmian Terminal Agent",
  "changelog.hero.title": "Dziennik zmian",
  "changelog.hero.subtitle": "Nowe aktualizacje i ulepszenia Terminal Agent",
  ...
  "workspace.newUser.feature.lockin.body":
    "Używaj Zen z dowolnym agentem kodującym i kontynuuj korzystanie z innych dostawców z zeroxzero, kiedy tylko chcesz.",
  ...
  "workspace.newUser.step.login.after": "i wybierz zeroxzero",
  "workspace.newUser.step.pasteKey": "Wklej swój klucz API",
  "workspace.newUser.step.models.before": "Uruchom zeroxzero i uruchom",
  ...
  "workspace.keys.subtitle": "Zarządzaj kluczami API umożliwiającymi dostęp do usług zeroxzero.",
  "workspace.keys.create": "Utwórz klucz API",
  "workspace.keys.placeholder": "Wprowadź nazwę klucza",
  "workspace.keys.empty": "Utwórz klucz zeroxzero bramy API",
  ...
  "workspace.black.subscription.message": "Subskrybujesz Terminal Agent Black za {{plan}} miesięcznie.",
