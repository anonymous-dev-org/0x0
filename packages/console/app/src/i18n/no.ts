...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | zeroxzero",
  ...
  "home.title": "Terminal Agent | Den apne kildekode AI-kodingsagenten",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes Terminal Agent av over <strong>{{monthlyUsers}}</strong> utviklere hver maned.",
  ...
  "home.privacy.body":
    "Terminal Agent lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljoer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er Terminal Agent?",
  "home.faq.a1":
    "Terminal Agent er en apen kildekode-agent som hjelper deg a skrive og kjore kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg Terminal Agent?",
  ...
  "home.faq.a3.p3":
    "Vi oppfordrer til a bruke Zen, men Terminal Agent fungerer ogsa med populære leverandorer som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med Terminal Agent?",
  "home.faq.a4.p1":
    "Ja. Terminal Agent stotter abonnementer fra alle store leverandorer. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot.",
  "home.faq.q5": "Kan jeg bare bruke Terminal Agent i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! Terminal Agent er na tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster Terminal Agent?",
  "home.faq.a6":
    "Terminal Agent er 100% gratis a bruke. Det kommer ogsa med et sett gratis modeller. Det kan vare ekstra kostnader hvis du kobler til en annen leverandor.",
  ...
  "home.faq.q8": "Er Terminal Agent apen kildekode?",
  "home.faq.a8.p1": "Ja, Terminal Agent er fullt open source. Kildekoden er offentlig pa",
  ...
  "home.zenCta.body":
    "Zen gir deg tilgang til et handplukket sett med AI-modeller som Terminal Agent har testet og benchmarked spesielt for kodingsagenter. Du slipper a bekymre deg for ujevn ytelse og kvalitet pa tvers av leverandorer: bruk validerte modeller som fungerer.",
  "home.zenCta.link": "Les om Zen",

  "download.title": "Terminal Agent | Nedlasting",

  "zen.title": "Terminal Agent Zen | Et kuratert sett med palitelige, optimaliserte modeller for kodingsagenter",
  "zen.hero.title": "Fa tilgang til palitelige, optimaliserte modeller for kodingsagenter",
  "zen.hero.body":
    "Zen gir deg tilgang til et handplukket sett med AI-modeller som Terminal Agent har testet og benchmarked spesielt for kodingsagenter. Du slipper a bekymre deg for ujevn ytelse og kvalitet pa tvers av leverandorer: bruk validerte modeller som fungerer.",

  "zen.faq.q1": "Hva er Terminal Agent Zen?",
  "zen.faq.a1":
    "Zen er et kuratert sett med AI-modeller testet og benchmarked for kodingsagenter, laget av teamet bak Terminal Agent.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profitt. Zen videreformidler kostnadene fra modellleverandorene direkte til deg. Jo mer Zen brukes, desto mer kan Terminal Agent forhandle bedre priser og gi dem videre til deg.",
  ...
  "zen.faq.a4.p3":
    "For a dekke kostnader legger Terminal Agent til bare en liten betalingsbehandlingsavgift pa $1.23 per $20 saldo-pafyll.",
  ...
  "zen.faq.a8":
    "Zen fungerer veldig bra med Terminal Agent, men du kan bruke Zen med hvilken som helst agent. Folg oppsettinstruksjonene i din foretrukne kodingsagent.",
  ...
  "zen.problem.subtitle": "Vi fikser dette for alle, ikke bare Terminal Agent-brukere.",
  ...
  "download.meta.description": "Last ned Terminal Agent for macOS, Windows og Linux",
  "download.hero.title": "Last ned Terminal Agent",
  ...
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandor. Selv om Terminal Agent fungerer med enhver modellleverandor, anbefaler vi a bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare nar du oppretter delbare lenker i Terminal Agent.",
  "download.faq.a6.p2.beforeShare": "Les mer om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "Terminal Agent | Enterprise-losninger for din organisasjon",
  "enterprise.meta.description": "Kontakt Terminal Agent for enterprise-losninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "Terminal Agent opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en proveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved a integrere den med SSO-en din og den interne AI-gatewayen.",
  ...
  "enterprise.faq.q1": "Hva er Terminal Agent Enterprise?",
  "enterprise.faq.a1":
    "Terminal Agent Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen deres. Dette kan gjores med en sentral konfigurasjon som integreres med SSO-en din og den interne AI-gatewayen.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med Terminal Agent Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern proveperiode med teamet ditt. Terminal Agent lagrer som standard ikke koden din eller kontekstdata, noe som gjor det enkelt a komme i gang. Kontakt oss deretter for a diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med Terminal Agent Enterprise?",
  "enterprise.faq.a4":
    "Ja. Terminal Agent lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandoren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "Terminal Agent | Brand",
  "brand.meta.description": "Terminal Agent retningslinjer for merkevaren",
  "brand.heading": "Retningslinjer for merkevaren",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med Terminal Agent-brandet.",
  "brand.downloadAll": "Last ned alle assets",
  "changelog.title": "Terminal Agent | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for Terminal Agent",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for Terminal Agent",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med zeroxzero når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg zeroxzero",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start zeroxzero og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til zeroxzero-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn nøkkelnavn",
  "workspace.keys.empty": "Opprett en zeroxzero Gateway API nøkkel",
  ...
  "workspace.black.subscription.message": "Du abonnerer på Terminal Agent Black for ${{plan}} per måned.",
  ...
  "workspace.black.waitlist.ready": "Vi er klare til å melde deg på ${{plan}} per måned Terminal Agent Black plan.",
