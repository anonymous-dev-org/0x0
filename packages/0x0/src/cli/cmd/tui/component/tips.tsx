...
const TIPS = [
  ...
  "Run {highlight}/agents{/highlight} or {highlight}Ctrl+X A{/highlight} to pick a specific agent",
  "Type {highlight}@{/highlight} in the prompt to open the agent/model/thinking picker",
  "Create {highlight}0x0.json{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/zeroxzero/0x0.json{/highlight} for global config",
  ...
  "Terminal Agent auto-handles OAuth for remote MCP servers requiring auth",
  "Add {highlight}.md{/highlight} files to {highlight}.zeroxzero/command/{/highlight} to define reusable custom prompts",
  ...
  "Terminal Agent auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Terminal Agent uses LSP servers for intelligent code analysis",
  "Create {highlight}.ts{/highlight} files in {highlight}.zeroxzero/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.zeroxzero/plugin/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent Terminal Agent from reading sensitive files",
  "Use {highlight}zeroxzero run{/highlight} for non-interactive scripting",
  "Use {highlight}zeroxzero --continue{/highlight} to resume the last session",
  "Use {highlight}zeroxzero run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}zeroxzero serve{/highlight} for headless API access to Terminal Agent",
  "Use {highlight}zeroxzero run --attach{/highlight} to connect to a running server",
  "Run {highlight}zeroxzero upgrade{/highlight} to update to the latest version",
  "Run {highlight}zeroxzero auth list{/highlight} to see all configured providers",
  "Run {highlight}zeroxzero agent create{/highlight} for guided agent creation",
  "Use {highlight}/zeroxzero{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}zeroxzero github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/zeroxzero fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/oc{/highlight} on PR code lines for targeted code reviews",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in {highlight}.zeroxzero/themes/{/highlight} directory",
  ...
  "Run {highlight}zeroxzero debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/zeroxzero{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with Terminal Agent Zen for curated, tested models",
