...
const TIPS = [
  ...
  "Create {highlight}0x0.yaml{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/zeroxzero/0x0.yaml{/highlight} for global config",
  ...
  "Use {highlight}0x0 run{/highlight} for non-interactive scripting",
  "Use {highlight}0x0 --continue{/highlight} to resume the last session",
  "Use {highlight}0x0 run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}0x0 serve{/highlight} for headless API access to Terminal Agent",
  "Use {highlight}0x0 run --attach{/highlight} to connect to a running server",
  "Run {highlight}0x0 upgrade{/highlight} to update to the latest version",
  "Run {highlight}0x0 auth list{/highlight} to see all configured providers",
  "Run {highlight}0x0 agent create{/highlight} for guided agent creation",
  "Use {highlight}/0x0{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}0x0 github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/0x0 fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}0x0 debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anonymous-dev-org/0x0{/highlight} for containerized use",
