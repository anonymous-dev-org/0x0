...
This directory contains a clean, protocol-compliant implementation of the [Agent Client Protocol](https://agentclientprotocol.com/) for 0x0.
...
- **`session.ts`** - Session state management
  ...
  - Maps ACP sessions to internal 0x0 sessions
...
- **Terminal Integration**: Full terminal support via 0x0's bash tool
...
echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":1}}' | 0x0 acp
```
...
ACP sessions map cleanly to 0x0's internal session model:
