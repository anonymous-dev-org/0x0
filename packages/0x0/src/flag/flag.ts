...
export namespace Flag {
  ...
  export const ZEROXZERO_DISABLE_PRUNE = truthy("ZEROXZERO_DISABLE_PRUNE")
  ...
  export const ZEROXZERO_DISABLE_AUTOCOMPACT = truthy("ZEROXZERO_DISABLE_AUTOCOMPACT")
  ...
  export const ZEROXZERO_EXPERIMENTAL_PLAN_MODE = ZEROXZERO_EXPERIMENTAL || truthy("ZEROXZERO_EXPERIMENTAL_PLAN_MODE")
