...
const commands = [
  ...
  lazy(
    ...
    command(() => import("./tui/thread"), "TuiThreadCommand"),
  ),
  lazy(
    {
      command: "attach <url>",
    ...
    command(() => import("./tui/attach"), "AttachCommand"),
  ),

  // Server commands (re-exported via lazy import)
  lazy(
    {
      command: "server",
      aliases: ["serve"],
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/serve"), "ServeCommand"),
  ),
  lazy(
    {
      command: "acp",
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/acp"), "AcpCommand"),
  ),
  lazy(
    {
      command: "mcp",
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/mcp"), "McpCommand"),
  ),
  lazy(
    {
      command: "run [message..]",
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/run"), "RunCommand"),
  ),
  lazy(
    {
      command: "generate",
    },
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/generate"), "GenerateCommand"),
  ),
  lazy(
    {
      command: "debug",
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/debug"), "DebugCommand"),
  ),
  lazy(
    {
      command: "agent",
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/agent"), "AgentCommand"),
  ),
  lazy(
    {
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/upgrade"), "UpgradeCommand"),
  ),
  lazy(
    {
      command: "uninstall",
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/uninstall"), "UninstallCommand"),
  ),
  lazy(
    {
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/models"), "ModelsCommand"),
  ),
  lazy(
    {
      command: "stats",
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/stats"), "StatsCommand"),
  ),
  lazy(
    {
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/export"), "ExportCommand"),
  ),
  lazy(
    {
      command: "import <file>",
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/import"), "ImportCommand"),
  ),
  lazy(
    {
      command: "github",
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/github"), "GithubCommand"),
  ),
  lazy(
    {
      command: "pr <number>",
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/pr"), "PrCommand"),
  ),
  lazy(
    {
      command: "session",
    ...
    command(() => import("@anonymous-dev/0x0-server/cli/cmd/session"), "SessionCommand"),
  ),
]
...
try {
  ...
  const { FormatError } = await import("@anonymous-dev/0x0-server/cli/error")
