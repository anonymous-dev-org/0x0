...
import type { AssistantMessage } from "@anonymous-dev/0x0-server/server/types"
          ...
          <Show when={!hasProviders() && !gettingStartedDismissed()}>
            ...
            >
              ...
              <box flexGrow={1} gap={1}>
                ...
                <text fg={theme.textMuted}>Terminal Agent includes free models so you can start immediately.</text>
                <text fg={theme.textMuted}>
