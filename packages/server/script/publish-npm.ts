...
const folders = [
  "0x0-server-linux-x64-baseline",
  "0x0-server-linux-x64",
  "0x0-server-darwin-arm64",
  "0x0-server-darwin-x64-baseline",
  "0x0-server-darwin-x64",
  "0x0-server-windows-x64",
  "0x0-server-linux-x64-baseline-musl",
  "0x0-server-linux-arm64",
  "0x0-server-linux-arm64-musl",
  "0x0-server-windows-x64-baseline",
  "0x0-server-linux-x64-musl",
]
