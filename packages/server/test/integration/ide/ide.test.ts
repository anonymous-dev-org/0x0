...
import { Ide } from "../../../src/integration/ide"
...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ZEROXZERO_CALLER", () => {
    process.env["ZEROXZERO_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ZEROXZERO_CALLER", () => {
    process.env["ZEROXZERO_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ZEROXZERO_CALLER", () => {
    process.env["ZEROXZERO_CALLER"] = "unknown"
