...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/zeroxzero.git")).toEqual({ owner: "sst", repo: "zeroxzero" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/zeroxzero")).toEqual({ owner: "sst", repo: "zeroxzero" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/zeroxzero.git")).toEqual({ owner: "sst", repo: "zeroxzero" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/zeroxzero")).toEqual({ owner: "sst", repo: "zeroxzero" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/zeroxzero.git")).toEqual({ owner: "sst", repo: "zeroxzero" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/zeroxzero")).toEqual({ owner: "sst", repo: "zeroxzero" })
})
