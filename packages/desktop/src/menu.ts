    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://zeroxzero.ai/docs"),
            text: "zeroxzero Documentation",
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/zeroxzero"),
            text: "Support Forum",
          }),
          await PredefinedMenuItem.new({
            item: "Separator",
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/anomalyco/zeroxzero/issues/new?template=feature_request.yml"),
            text: "Share Feedback",
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/anomalyco/zeroxzero/issues/new?template=bug_report.yml"),
            text: "Report a Bug",
          }),
        ],
      }),
