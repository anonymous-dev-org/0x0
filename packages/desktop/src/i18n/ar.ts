export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من zeroxzero",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من zeroxzero، هل ترغب في تثبيته وإعادة تشغيله؟",
