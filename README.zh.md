...
brew install anonymous-dev-org/tap/0x0 # macOS 和 Linux
```
...
了解更多 [Agents](https://docs.anonymous.dev/packages/0x0-cli/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://docs.anonymous.dev/packages/0x0-cli)。
